...
<head>
    ...
    <link rel="stylesheet" href="./estilos/agregarPlato.css">
    ...
    <div class="contenedor-formulario contenedor animated zoomInDown">
        ...
        <form class="formulario" action="#" method="post">
            ...
            <div class="tabla">
                <table>
                    <tr>
                        <td class="textcamp">Nombre del plato:</td>
                        <td>
                            <div class="reg-rest">
                                <input type="text" class="input" value="combo 3">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="textcamp">Precio:</td>
                        <td>
                            <div class="reg-rest">
                                <input type="text" class="input" value="2.60">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="textcamp">Tiempo de espera (minutos):</td>
                        <td>
                            <div class="reg-rest">
                    ...
                    <tr>
                        <td class="textcamp">Categoría del plato:</td>
                        <td>
                    ...
                    <tr>
                        <td class="textcamp">Foto del plato:</td>
                        <td>
                            <div class="reg-rest">
