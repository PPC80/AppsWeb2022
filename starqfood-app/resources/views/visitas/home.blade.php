        ...
        <div class="hero">
            ...
            <div class="navbar-img">
                <ul class="navbar">
                    ...
                    <li><a href="./login.html" class="nav">Iniciar sesión</a></li>
                </ul>
                <img src="./img/img-user/user2.png" class="user-pic" onclick="toggleMenu()">
                <div class="sub-menu-wrap" id="subMenu">
                    <div class="sub-menu">
                        <div class="user-info">
                            <img src="./img/img-user/user2.png" alt="">
                            <h3>Roberto Chacón</h3>
                        </div>
                        <hr>
                        <a href="./perfilUser.html" class="sub-menu-link">
                            <img src="./img/img-user/profile.png">
                            <p>Editar perfil</p>
                            <span> > </span>
                        </a>
                        <a href="#" class="sub-menu-link">
                            <img src="./img/img-user/logout.png">
                            <p>Cerrar sesión</p>
                            <span> > </span>
                        </a>
                    </div>
        ...
        <section class="about" id="about">
            ...
            <div  class="about-text">
                ...
                <p>
                    ...
                    exclusivos. Al buscar un lugar donde comer, pensamos en el lugar, la calidad y también en la comodidad de todos.
        ...
        <section class="services" id="services">
            ...
            <div class="service-container">
                ...
                <div class="s-box">
                    ...
                    <p>
                        El tiempo de preparación de un platillo en un restaurante puede variar dependiendo de varios factores,
                        ...
                        del personal de cocina. En general, los restaurantes tienen una estimación del tiempo de preparación para cada platillo,
                        y se esfuerzan por cumplir con este tiempo para satisfacer a los clientes.
                    </p>
                </div>

                <div class="s-box">
                    <img src="img/restaurante.png">
